...
class Edge(Shape, VertexContainerMixin, BoundingBoxMixin):
    ...
    def make_line_from_points(start_point, end_point):
        ...
        Returns:
            app.occwl.Edge: Edge joining the two given vertices
            or None: if error
        """
    ...
    def start_vertex(self):
        ...
        Returns:
            app.occwl.vertex.Vertex: Start vertex
        """
        return app.occwl.vertex.Vertex(ShapeAnalysis_Edge().FirstVertex(self.topods_shape()))
    ...
    def end_vertex(self):
        ...
        Returns:
            app.occwl.vertex.Vertex: End vertex
        """
        return app.occwl.vertex.Vertex(ShapeAnalysis_Edge().LastVertex(self.topods_shape()))
    ...
    def u_bounds(self):
        ...
        Returns:
            app.occwl.geometry.Interval: a 1D interval [u_min, u_max]
        """
        if not self.has_curve():
    ...
    def reversed_edge(self):
        ...
        Returns:
            app.occwl.edge.Edge: An edge with the opposite orientation to this edge.
        """
    ...
    def find_left_and_right_faces(self, faces):
        ...
        Returns:
            app.occwl.face.Face, app.occwl.face.Face: The left and then right face
        """
        assert len(faces) > 0
        face1 = faces[0]
        if len(faces) == 1:
