...
class Wire(Shape):
    ...
    def make_from_edges(edges):
        ...
        Args:
            edges (List[app.occwl.edge.Edge]): List of edges

        Returns:
            app.occwl.wire.Wire or None: Returns a Wire or None if the operation failed
        """
    ...
    def ordered_edges(self):
        ...
        Returns:
            Iterator[app.occwl.edge.Edge]: An iterator to edges
        """
    ...
    def ordered_vertices(self):
        ...
        Returns:
            Iterator[app.occwl.vertex.Vertex]: An iterator to vertices
        """
