...
class Face(Shape, BoundingBoxMixin, TriangulatorMixin, WireContainerMixin, \
    ...
    def make_prism(profile_edge, vector, return_first_last_shapes=False):
        ...
        Returns:
            app.occwl.Face: Face created by sweeping the edge
            or None: if error
            app.occwl.Edge, app.occwl.Edge (optional): Returns the base and top edges of return_first_last_shapes is True.
        """
    ...
    def make_nsided(edges, continuity="C0", points=None):
        ...
        Returns:
            app.occwl.face.Face: Filled-in face
        """
    ...
    def make_from_wires(wires):
        ...
        Returns:
            app.occwl.face.Face or None: Returns a Face or None if the operation failed
        """
    ...
    def reversed_face(self):
        ...
        Returns:
            app.occwl.face.Face: A face with the opposite orientation to this face.
        """
