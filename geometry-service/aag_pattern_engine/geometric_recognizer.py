"""
Geometric Feature Recognizer - Production Grade

Simple, focused recognition with strict validation:
...
3. Counterbores: 2-3 coaxial cylinders with strict validation
4. Countersinks: Conical faces + coaxial cylinder (edge sharing)
5. Tapered holes: Standalone conical faces
"""
import logging
import math
