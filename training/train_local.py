...
def main():
    ...
    parser.add_argument("--dataset_id", type=str, required=True, help="Dataset ID from Supabase")
    ...
    # Step 5: Upload model to Supabase
    print("=" * 80)
    ...
    print(f"Model path: {storage_filename}")
