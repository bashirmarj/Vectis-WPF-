        ...
        <div className="container-custom section-spacing">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <AnimatedSection animation="fadeRight">
              <div className="relative rounded-lg shadow-xl border border-gray-200 overflow-hidden aspect-[4/3]">
                <img 
                  src={missionHeroImg} 
              ...
              <div className="space-y-8">
                <div>
                  <div className="flex items-start gap-2 mb-4">
                    ...
                    <h2 className="text-3xl font-bold text-gray-900 tracking-tight font-mono uppercase">Our Mission</h2>
                  </div>
                ...
                <div>
                  <div className="flex items-start gap-2 mb-4">
                    <div className="w-1 h-8 bg-primary rounded-full"></div>
                    <h2 className="text-3xl font-bold text-gray-900 tracking-tight font-mono uppercase">Our Vision</h2>
                  </div>
                  <p className="text-lg text-gray-600 leading-relaxed">
          ...
          <AnimatedSection animation="fadeUp">
            <div className="text-center max-w-3xl mx-auto mb-16">
              <div className="flex items-start gap-2 mb-4 justify-center">
                <div className="w-1 h-8 bg-primary rounded-full"></div>
                <h2 className="text-3xl font-bold text-gray-900 tracking-tight font-mono uppercase">Our Core Values</h2>
              </div>
        ...
        <div className="container-custom section-spacing">
          <AnimatedSection animation="fadeUp">
            <div className="max-w-3xl mx-auto text-center">
              <div className="flex items-start gap-2 mb-4 justify-center">
                <div className="w-1 h-8 bg-primary rounded-full"></div>
                <h2 className="text-3xl font-bold text-gray-900 tracking-tight font-mono uppercase">Expertise Across Industries</h2>
              </div>
