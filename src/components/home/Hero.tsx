        ...
        <div className="max-w-4xl">
          ...
          >
            ...
            <motion.a 
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="group bg-[#F0EFEA] border border-slate-300 hover:bg-slate-200 text-slate-800 px-8 py-4 rounded-sm font-bold uppercase tracking-widest text-sm transition-colors flex items-center justify-center gap-2 shadow-sm"
            >
