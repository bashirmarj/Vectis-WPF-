...
const Navigation = () => {
  ...
  return <nav className="fixed top-0 left-0 right-0 z-50 bg-[#F5F5F2]/95 backdrop-blur-md border-b border-slate-200 shadow-sm">
      <div className="container mx-auto px-6">
              ...
              {navItems.map(item => <NavigationMenuItem key={item.path}>
                  {item.subItems ? <>
                      ...
                      <NavigationMenuContent>
                        <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] bg-[#F5F5F2]/95 backdrop-blur-md border border-slate-200 shadow-lg z-50">
        ...
        {/* Mobile Menu */}
        {isOpen && <div className="md:hidden border-t border-slate-200 bg-[#F5F5F2]/95 backdrop-blur-md">
